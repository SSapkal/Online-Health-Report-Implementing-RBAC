...
<body style="background-image:url(medical-563427_960_720.jpg);">
 ...
 <li><a href="logout_d.jsp" >Logout </a></li>
	...
	<h1 align="center">Urine Test Report</h1>
		<table id="keywords" cellspacing="0" cellpadding="0">
		    <thead>
		      <tr>
		        <th><span>Dr Name</span></th>
		        <th><span>Date</span></th>
		        <th><span>Blood</span></th>
		        <th><span>Protein</span></th>
		        <th><span>Glucose</span></th>
		        <th><span>Sugar</span></th>
		        <th><span>PH</span></th>
		        <th><span>Diagnosis</span></th>
		        <th><span>Add Instructions</span></th>
		      </tr>
		    </thead>
		<%
			try
			{
				...
				String query="select * from urinetest where patientid='"+s+"'";
